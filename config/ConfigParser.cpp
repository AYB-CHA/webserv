...
Token ConfigParser::consumeSrvKeyword() {
...
Token ConfigParser::consumeLocKeyword() {
    if (!tokens.size()) throw std::runtime_error("Expected directive.");
